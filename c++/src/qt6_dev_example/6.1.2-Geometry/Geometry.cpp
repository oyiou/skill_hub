...
void Geometry::updateLabel() {
    ...
    frameStr =
            tempStr1.setNum(frameGeometry().x()) + "," +
    ...
    QString wStr,hStr;
    widthValueLabel->setText(wStr.setNum(QWidget::width()));
    heightValueLabel->setText(hStr.setNum(QWidget::height()));

    QString rectStr;
    QString tempStr31,tempStr32,tempStr33,tempStr34;
    rectStr =
            tempStr31.setNum(rect().x()) + "," +

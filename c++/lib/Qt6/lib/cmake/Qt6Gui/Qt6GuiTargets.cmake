...
foreach(_expectedTarget Qt6::Gui Qt6::GuiPrivate Qt6::Gui_resources_1)
...
set_target_properties(Qt6::Gui PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "Qt6::Core;\$<LINK_ONLY:Qt6::CorePrivate>;\$<LINK_ONLY:Qt6::PlatformModuleInternal>;\$<\$<AND:\$<NOT:\$<BOOL:\$<TARGET_PROPERTY:_qt_object_libraries_finalizer_mode>>>,\$<NOT:\$<STREQUAL:\$<TARGET_PROPERTY:TYPE>,STATIC_LIBRARY>>,\$<NOT:\$<BOOL:\$<TARGET_PROPERTY:Qt6::Platform,_qt_link_order_matters>>>,\$<BOOL:TRUE>>:\$<TARGET_OBJECTS:Qt6::Gui_resources_1>>;Qt6::Gui_resources_1;d3d11;dxgi;dxguid;\$<LINK_ONLY:advapi32>;\$<LINK_ONLY:gdi32>;\$<LINK_ONLY:ole32>;\$<LINK_ONLY:shell32>;\$<LINK_ONLY:user32>;\$<LINK_ONLY:WrapPNG::WrapPNG>;\$<LINK_ONLY:WrapHarfbuzz::WrapHarfbuzz>;\$<LINK_ONLY:WrapFreetype::WrapFreetype>;\$<LINK_ONLY:WrapFreetype::WrapFreetype>;\$<LINK_ONLY:d2d1>;\$<LINK_ONLY:dwrite>;\$<LINK_ONLY:uuid>;\$<LINK_ONLY:WrapZLIB::WrapZLIB>;\$<TARGET_NAME_IF_EXISTS:WrapVulkanHeaders::WrapVulkanHeaders>"
  INTERFACE_LINK_OPTIONS "\$<\$<AND:\$<NOT:\$<STREQUAL:\$<TARGET_PROPERTY:TYPE>,STATIC_LIBRARY>>,\$<BOOL:\$<TARGET_PROPERTY:Qt6::Platform,_qt_link_order_matters>>,\$<BOOL:\$<GENEX_EVAL:\$<TARGET_PROPERTY:Qt6::Platform,_qt_cmp0099_policy_check>>>,\$<BOOL:TRUE>>:\$<TARGET_OBJECTS:Qt6::Gui_resources_1>>"
  INTERFACE_QT_MAJOR_VERSION "6"
  INTERFACE_SOURCES "\$<\$<BOOL:\$<TARGET_PROPERTY:QT_CONSUMES_METATYPES>>:${_IMPORT_PREFIX}/lib/metatypes/qt6gui_release_metatypes.json>;\$<\$<AND:\$<NOT:\$<BOOL:\$<TARGET_PROPERTY:_qt_object_libraries_finalizer_mode>>>,\$<NOT:\$<STREQUAL:\$<TARGET_PROPERTY:TYPE>,STATIC_LIBRARY>>,\$<BOOL:\$<TARGET_PROPERTY:Qt6::Platform,_qt_link_order_matters>>,\$<NOT:\$<BOOL:\$<GENEX_EVAL:\$<TARGET_PROPERTY:Qt6::Platform,_qt_cmp0099_policy_check>>>>,\$<BOOL:TRUE>>:\$<TARGET_OBJECTS:Qt6::Gui_resources_1>>"
  ...
  QT_DISABLED_PRIVATE_FEATURES "accessibility_atspi_bridge;directfb;evdev;fontconfig;system_harfbuzz;qqnx_imf;integrityfb;kms;drm_atomic;libinput;integrityhid;libinput_axis_api;linuxfb;vsp2;vnc;mtdev;vkkhrdisplay;egl_x11;eglfs;eglfs_brcm;eglfs_egldevice;eglfs_gbm;eglfs_vsp2;eglfs_mali;eglfs_viv;eglfs_rcar;eglfs_viv_wl;eglfs_openwfd;eglfs_x11;tslib;xcb_glx;xcb_egl_plugin;xcb_native_painting;xrender;xcb_xlib;xcb_sm;system_xcb_xinput;xkbcommon;xkbcommon_x11;xlib"
  QT_DISABLED_PUBLIC_FEATURES "accessibility_atspi_bridge;fontconfig;opengles2;opengles3;opengles31;opengles32;openvg;egl;xcb;xcb_glx_plugin;system_textmarkdownreader"
  QT_ENABLED_PRIVATE_FEATURES "directwrite;directwrite3;direct2d;direct2d1_1;freetype;system_freetype;harfbuzz;vkgen;gif;ico;jpeg;system_jpeg;png;system_png;imageio_text_loading;tuiotouch;multiprocess;raster_64bit;raster_fp"
...
set_target_properties(Qt6::GuiPrivate PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/QtGui/6.2.4;${_IMPORT_PREFIX}/include/QtGui/6.2.4/QtGui"
